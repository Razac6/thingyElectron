...
function Settings() {
  ...
  const handleSleepTrackingChange = (
    ...
    <Box sx={{ maxWidth: 800, mx: 'auto', pb: 5 }}>
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        ...
        >
          ...
          <Button
            variant="outlined"
            startIcon={
              training ? <CircularProgress size={20} /> : <AutoFixHighIcon />
            }
        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            ...
            <Typography variant="body2" color="text.secondary">
              Tasks estimated longer than this will trigger a complexity warning
              suggesting a breakdown.
            </Typography>
            <Box sx={{ px: 2, mt: 2 }}>
              <Slider
            ...
            <Typography align="center" sx={{ mt: 1 }}>
              Current: {settings.complexityThreshold}h
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <Typography variant="body2" color="text.secondary">
              How many days of history to show on the Dashboard contribution
              graph.
            </Typography>
            <Box sx={{ px: 2, mt: 2 }}>
              <Slider
            ...
            <Typography align="center" sx={{ mt: 1 }}>
              Last {settings.activityGraphDays || 365} days
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <Typography
              ...
              sx={{ ml: 4 }}
            >
              Receive notifications when you work too long without breaks or
          ...
          <Grid item xs={12}>
            ...
            <Typography
              ...
              sx={{ ml: 4 }}
            >
              Get notified if you haven&apos;t completed your daily habits (3 hours
              after reminder time).
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <Typography
              ...
              sx={{ ml: 4 }}
            >
              Show Sleep Score input in Smart Insights. Data is used to adjust
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Grid container spacing={3}>
          ...
          {/* macOS Exclusive Features - Dynamic Notch */}
          {window.electron?.platform === 'darwin' && (
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Switch
                    checked={settings.enableMacosNotch === 'true'}
                    onChange={(e) =>
                      updateSetting(
                        'enableMacosNotch',
                        String(e.target.checked),
                ...
                label="Enable Dynamic Notch (Ghost in the Machine)"
              />
                    <Typography variant="caption" display="block" color="text.secondary" sx={{ ml: 4 }}>
                        When minimized, the app inhabits the Notch area as a compact status widget.
                    </Typography>
            </Grid>
          )}
        </Grid>
