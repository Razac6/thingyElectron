...
contextBridge.exposeInMainWorld('electron', {
  database: {
    ...
    getChecklistItems: (taskId: number) => ipcRenderer.invoke('db:get-checklist-items', taskId),
    addChecklistItem: (taskId: number, text: string) => ipcRenderer.invoke('db:add-checklist-item', taskId, text),
    ...
    getDailyMode: (date: string) => ipcRenderer.invoke('db:get-daily-mode', date),
    setDailyMode: (date: string, mode: string) => ipcRenderer.invoke('db:set-daily-mode', date, mode),
