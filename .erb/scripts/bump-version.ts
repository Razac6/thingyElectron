...
const isPluginMode = args.includes('--plugin');
...
if (isPluginMode) {
    ...
    console.log(`Target: ${chalk.magenta('Chrome Extension')}`);
    ...
    rl.question(chalk.blue(`\nEnter new extension version (current is ${manifest.version}): `), (input) => {
        ...
        console.log(chalk.green(`\nExtension version updated to ${chalk.bold(newVersion)} 🚀`));
        rl.close();
    });
    ...
    console.log(`Target: ${chalk.magenta('Electron Application')}`);
    ...
    rl.question(chalk.blue(`\nEnter new app version (current is ${rootPkg.version}): `), (input) => {
      const newVersion = input.trim();
      ...
      console.log(chalk.green(`\nApp version bumped to ${chalk.bold(newVersion)} 🚀`));
      rl.close();
    });
}
